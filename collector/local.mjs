...
const env = { DB: sqliteAdapter(database), ALLOWED_ORIGINS: process.env.ALLOWED_ORIGINS || 'http://127.0.0.1:4173,http://localhost:4173' };
...
}).listen(Number(process.env.COLLECTOR_PORT || 8787), '127.0.0.1', () => console.log('Local collector: http://127.0.0.1:8787'));
