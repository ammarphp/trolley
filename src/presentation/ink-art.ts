...
export const INK = 0x282828;
export const PAPER = 0xffffff;
export const RED = 0x9a4e42;
export const SOFT_SHADE = 0xe9e9e9;
export type ArtKind =
  | "tree"
  | "bare-tree"
  | "cow"
...
const paths: Partial<Record<ArtKind, string>> = {
  hat: '<path fill="#ffffff" d="M-27-23L-24-49Q0-61 24-49L27-23Q0-13-27-23Z"/><path fill="#e9e9e9" d="M-27-23Q0-34 27-23L38-15Q9 5-35-10Z"/><path d="M-24-42Q0-48 24-42M-22-26Q0-32 22-26M-22-16Q0-20 26-14"/><path d="M-6-45h12v9H-6Z" fill="#282828"/><circle cy="-40" r="2" fill="#ffffff"/>',
  umbrella:
    '<path fill="#ffffff" d="M-40-36Q-26-72 0-75Q28-72 40-36Q27-44 16-35Q0-43-16-35Q-27-43-40-36Z"/><path d="M0-79V-7Q0 7 12 3Q18 1 15-7M0-75Q-15-63-16-35M0-75Q15-63 16-35M0-75V-39"/><path d="M-36-35l-2 5M37-35l2 5"/>',
  cup: '<path fill="#ffffff" d="M-16-33h31l-3 28q-11 7-24 0Z"/><path d="M15-29q24-4 19 11q-3 10-21 7M-23 2q22 6 46 0M-7-42q-10-9 0-16M7-42q10-8 2-17"/><path d="M-16-32q16 5 31 0" stroke-width="1"/>',
  parcel:
    '<path fill="#ffffff" d="M-23-43L16-48 29-36 25-4-17 0-25-10Z"/><path d="M-23-43l13 13 39-6M-10-30l-7 30M-4-46l12 12-4 31M-24-16l7 4"/><path d="M-7-22l11-1-1 11-12 1Z" fill="#e9e9e9" stroke-width="1"/>',
  tree: '<path d="M-9 0L-6-50 -14-69M7 0L5-52 18-73M-5-37L-25-55M5-44L24-58"/><path fill="#ffffff" d="M-31-48C-58-47-63-76-45-89C-54-112-25-126-10-114C5-139 33-118 30-100C58-106 67-80 47-66C48-44 23-37 8-48C-7-30-25-34-31-48Z"/><path d="M-42-74q-10-15 5-24M-20-103q14-9 21 3M18-83q17-12 25 2M-18-64q10 5 16-2" stroke-width="1.1"/><path d="M-17 1q18-5 35 1"/>',
  "bare-tree":
  ...
  cow: '<path fill="#ffffff" d="M-42-41Q-48-70-13-68L22-64 30-54 48-49 52-27 34-22 21-33 11-24-30-25Z"/><path d="M-34-27L-35-3 -27-2 -23-27M2-25L5-3 13-3 13-28M35-46L33-61 42-54M45-49L52-61 56-53M-43-54Q-65-52-56-26"/><path fill="#282828" d="M-30-62q14-7 18 5l-5 16-19-4ZM3-54q18-10 18 9l-13 10Z"/><circle cx="43" cy="-37" r="2" fill="#282828"/><path d="M46-27l5-2M-41-2h18M4-1h13"/>',
  sheep:
    '<path fill="#ffffff" d="M-30-15Q-45-22-35-34Q-42-47-26-47Q-25-64-10-55Q5-70 13-54Q31-62 33-44Q48-42 39-28Q40-11 24-13Q7-1-6-13Q-20-4-30-15Z"/><path d="M-24-16l-3 16M13-13l3 12M28-35q24-8 19 12l-13 4Z"/><circle cx="41" cy="-30" r="1.5" fill="#282828"/>',
  house:
    '<path fill="#ffffff" d="M-44 0L-43-63-51-62 0-105 52-66 44-63 44 0Z"/><path d="M-43-64L0-97 44-64M-12 0v-37h24V0M-32-51h14v17h-14ZM20-51h14v17H20M-56 1h113"/><path d="M23-83v-26h10v35"/>',
  clinic:
    '<path fill="#ffffff" d="M-62 0v-100h124V0Z"/><path d="M-67-101h134M-21 0v-43h42V0M0-43V0M-48-79h19v19h-19ZM28-79h19v19H28M-48-44h18v19h-18M30-44h18v19H30"/><path d="M0-92v31M-15-77H15" stroke="#9a4e42" stroke-width="5"/><path d="M-68 1h137"/>',
  server:
    '<path fill="#ffffff" d="M-39 0v-145l57-5 21 14V0Z"/><path d="M18-150V0M-39-123h57M-39-99h57M-39-75h57M-39-51h57M-39-27h57M23-131l11 7M23-105l11 7M23-79l11 7M23-53l11 7"/><path d="M-30-136h22M-30-111h22M-30-87h22M-30-63h22M-30-39h22M-30-15h22" stroke-width="1"/><circle cx="8" cy="-135" r="2"/><circle cx="8" cy="-111" r="2"/><circle cx="8" cy="-87" r="2"/><circle cx="8" cy="-63" r="2"/><circle cx="8" cy="-39" r="2"/><circle cx="8" cy="-15" r="2"/>',
  pylon:
  ...
  drone:
    '<path fill="#ffffff" d="M-17-13L0-20 18-12 3 0Z"/><path d="M-11-14l-26-10M11-15l26-12M-4-3l-24 9M10-6l25 8"/><ellipse cx="-38" cy="-26" rx="19" ry="4"/><ellipse cx="38" cy="-28" rx="19" ry="4"/><ellipse cx="-29" cy="7" rx="17" ry="4"/><ellipse cx="36" cy="3" rx="17" ry="4"/><circle cx="2" cy="-11" r="3" fill="#9a4e42" stroke="#9a4e42"/>',
  flower:
    '<path d="M0 0L-1-22M-1-8q-17-1-9-8l9 5M0-10q13-9 12-2L0-5"/><path d="M-1-22q-14-1-8-8q-8-12 4-9q4-12 10-2q13-4 10 7q9 8-4 9q-4 10-12 3Z" fill="#e9e9e9"/>',
  person:
    '<path d="M-2-40L0-19 -10-2M0-19L10-1M-2-34L-17-24 -21-31M-1-34L12-27 17-36" stroke-width="2.7"/><path fill="#ffffff" d="M-9-62Q-3-70 5-63Q13-58 8-46Q4-38-5-42Q-13-46-9-62Z"/><path d="M-10-62q10-10 19 1M-4-48q5 4 9-1" stroke-width="1.3"/><circle cx="-3" cy="-55" r="1" fill="#282828"/><circle cx="4" cy="-55" r="1" fill="#282828"/><path d="M-5-40l6 10 4-12M-11-1h6M9 0h7" stroke-width="1.5"/>',
  robot:
    '<path fill="#ffffff" d="M-11-60h24v20h-24ZM-9-36h20v21H-9Z"/><path d="M-2-39v3M-10-33L-21-25 -16-13M12-32L23-25 20-14M-5-15L-8-2 -16-2M7-15l5 13h8M1-61v-10"/><circle cx="1" cy="-72" r="3"/><circle cx="-4" cy="-51" r="2"/><circle cx="6" cy="-51" r="2"/><path d="M-3-44h8M-5-28H7M-5-23H7"/>',
  ...
  column:
    '<path fill="#ffffff" d="M-20 0L-13-130Q0-154 13-130L20 0Z"/><path d="M-6-120V-8M6-120V-8M-22-1h44M-15-137h30"/><circle cy="-141" r="4" fill="#e9e9e9"/>',
};
...
const details: Partial<Record<ArtKind, string>> = {
  ...
  clinic:
    '<path d="M-68 7h138M-58-88v-5h15M43-93h14v5M-55-55h102M-13-40v34M13-40v34M-46-35h14M31-35h14M-8-23h3M5-23h3M-56-8h25M32-8h24"/><path d="M-31-119h62v13h-62Z" fill="#ffffff"/><path d="M-23-114h8M-9-114h8M5-114h8M19-114h5"/>',
  server:
...
export function artSvg(kind: ArtKind, pose: GlyphPose = {}): string {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#282828" stroke-width="3.4" stroke-linecap="round" stroke-linejoin="round">${body}</g></svg>`;
}
