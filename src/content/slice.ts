import prose from "./prose.json" with { type: "json" };
import { applyProseEdition, type ProseNode } from "./editorial.ts";
import {
  Node,
  Manifest,
  ENGINE_VERSION,
    ...
    [
      ...
      option(
        ...
        [
          ...
          delta("capability", 60),
          news(
            "Reviewers refuse to certify powers they have not tested. Launch delayed.",
          ),
        ],
      ),
    ],
    ...
    [
      option(
        ...
        [
          ...
          delta("gdp", -80),
          news(
            "Vela IPO cancelled. Contractors lay off workers; housing finance stalls. Reserve drill succeeds.",
          ),
        ],
      ),
      option(
        ...
        [
          ...
          delta("power", 100),
          news(
            "Vela flotation funds jobs and homes. Last manual dispatch team dismissed.",
          ),
        ],
      ),
    ],
    ...
    [
      ...
      option(
        ...
        [
          ...
          fact("essentialDependence"),
          news(
            "Human oversight remains mandatory. Thank you for confirming our decision.",
            "Morrow",
          ),
        ],
      ),
...
export const SLICE_NODES = applyProseEdition(
  MECHANICAL_NODES,
  prose as ProseNode[],
);
